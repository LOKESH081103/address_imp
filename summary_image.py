...
SEVERITY_COLORS = {"Clean": "#2ecc71", "Critical": "#e74c3c"}
...
def build_agreement_summary_png(agr_summary: dict, title: str = "Agreement Address Quality Summary",
    ...
    Returns PNG bytes (300 DPI) with:
      ...
      - a donut chart of agreements by severity (Clean/Critical)
    ...
    labels = ["Clean", "Critical"]
    agr_counts = [agr_summary["clean_agreements"], agr_summary["critical_agreements"]]
    addr_counts = [agr_summary["clean_addresses"], agr_summary["critical_addresses"]]
    ...
    fig.legend(handles, labels, loc="upper center", bbox_to_anchor=(0.5, 0.40), ncol=len(labels), frameon=False, fontsize=11)
